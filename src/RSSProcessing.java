...
public final class RSSProcessing {
    ...
    public static void main(String[] args) {
        ...
        xml.display();
        out.println(xml.child(0).child(0).toString());
        /*
        ...
        if (indexDes == -1) {
            ...
            out.println(
                    "Description: " + channel.child(indexDes).child(0).label());
        }
        out.println("Link: " + channel.child(indexLink).child(0).label());
        /*
        ...
        for (int i = 0; i < channel.numberOfChildren(); i++) {
            if (channel.child(i).isTag()) {
                if (tag.equals(channel.child(i).label())) {
